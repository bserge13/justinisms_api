...
saying_11 = Justinism.create!(saying: "I'm busier than a cat trying to cover up crap on a marble floor")
saying_11 = Justinism.create!(saying: "I'm busier than a one-legged man in a butt-kicking contest")